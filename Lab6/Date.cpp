...
const string Date::MONTHS[12] = {"JANUARY", "FEBURARY", "MARCH", "APRIL", "MAY", "JUNE", "JULY", "AUGuST", "SEPTEMBER", "OCTOBER", "NOVEMBER", "DECEMBER"};
...
{
    stringstream date;
    date << left << setw(10) << MONTHS[month - 1] << setw(3) << day << setw(5) << year << endl;
    return date.str();
}
